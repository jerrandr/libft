...
SRCS =  ft_atoi.c ft_isdigit.c ft_memmove.c ft_split.c ft_strlcpy.c \
		ft_strtrim.c ft_bzero.c ft_isprint.c ft_memset.c ft_strchr.c ft_strlen.c \
		ft_substr.c ft_calloc.c ft_itoa.c ft_putchar_fd.c ft_strdup.c ft_strmapi.c ft_tolower.c \
